      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            { name: " Jean claude Nsanzimana", role: "Design Director", desc: "Nsanzimana brings innovative design thinking and technical expertise to every project, ensuring form and function work in perfect harmony." },
