    ...
    <div className="min-h-screen bg-white text-black font-light">
      ...
      >
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <motion.div variants={slideInLeft}>
            <h2 className="text-3xl md:text-4xl font-thin mb-6">Our Mission</h2>
            ...
            <h2 className="text-3xl md:text-4xl font-thin mb-6">Our Vision</h2>
            <p className="text-gray-700 leading-relaxed mb-6">
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <motion.div 
            className="text-center p-8 border border-gray-200 hover:border-black transition-colors duration-300"
            variants={fadeInUp}
          ...
          >
            ...
            <div className="space-y-6">
              <div className="border-l-2 border-black pl-6">
                ...
                <p className="text-gray-700">Understanding your unique requirements and vision.</p>
              </div>
              <div className="border-l-2 border-black pl-6">
                <h3 className="text-xl font-medium mb-2">Design</h3>
                <p className="text-gray-700">Creating innovative solutions that exceed expectations.</p>
              </div>
              <div className="border-l-2 border-black pl-6">
                <h3 className="text-xl font-medium mb-2">Development</h3>
                <p className="text-gray-700">Refining designs through collaboration and iteration.</p>
              </div>
              <div className="border-l-2 border-black pl-6">
                <h3 className="text-xl font-medium mb-2">Delivery</h3>
                <p className="text-gray-700">Bringing your vision to life with precision and care.</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">Principal Architect & Founder</p>
            <p className="text-gray-700 text-sm leading-relaxed">
              With over 20 years of experience, Sarah leads our design vision and ensures every project reflects our commitment to excellence.
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-medium mb-2">Michael Rodriguez</h3>
            <p className="text-gray-600 mb-4">Design Director</p>
            <p className="text-gray-700 text-sm leading-relaxed">
              Michael brings innovative design thinking and technical expertise to every project, ensuring form and function work in perfect harmony.
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-medium mb-2">Emily Thompson</h3>
            <p className="text-gray-600 mb-4">Sustainability Director</p>
            <p className="text-gray-700 text-sm leading-relaxed">
              Emily champions our environmental initiatives, ensuring every project contributes to a more sustainable future.
            </p>
          </motion.div>
        </div>
      </motion.section>
      ...
      >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <motion.div 
            ...
            variants={fadeInUp}
          >
            <div className="text-4xl font-thin text-gray-800 mb-2">15+</div>
          ...
          <motion.div 
            ...
            variants={fadeInUp}
          >
            <div className="text-4xl font-thin text-gray-800 mb-2">200+</div>
          ...
          <motion.div 
            ...
            variants={fadeInUp}
          >
            <div className="text-4xl font-thin text-gray-800 mb-2">50+</div>
          ...
          <motion.div 
            ...
            variants={fadeInUp}
          >
            <div className="text-4xl font-thin text-gray-800 mb-2">12</div>
      ...
      >
        <motion.div variants={fadeInUp}>
          ...
          <motion.button 
            className="bg-black text-white px-8 py-4 text-lg font-light hover:bg-gray-800 transition-colors duration-300"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
            Start Your Project
